...
import BNLV_learning.Learning.StructureLearning2.{generate_EdgeConstraint_Violate_Increnmental, generate_Initial_Structure_Increnmental}
...
object StructureLearning_alarm {
...
//		output.structureToConsole(bn)
		generate_Alarm_Structure(alarm_structure)
//		output.structureToConsole_matrix(alarm_structure)
		...
		outLog.write("初始结构：\r\n")
		output.structureAppendFile(bn.structure, logFile.structureLearning, bn.NodeNum) // 按文件追加的方式，输出结构约束到文件
		outLog.close()
...
//		output.CPT_FormatToConsole(bn)
		...
		Q_BIC(bn)
		StructureLearning_alarm.old_score_BIC = bn.Q_BIC.sum
//		println(StructureLearning_alarm.old_score_BIC)
//		System.exit(0)
...
//		existed_candidate_num = candidate.num
//		//反转边
//		Search.reverse_edge(current_model, EdgeConstraint_violate, n, candidate_model, candidate, current_node)
//		outCandidate = new FileWriter(logFile.candidateStructure, true)
...
//		outLog_BIC.close()
	...
	def generate_Alarm_Structure(structure: Array[Array[Int]]): Unit ={
		structure(1-1)(24-1) = 1
		structure(1-1)(23-1) = 1
		structure(2-1)(26-1) = 1
		structure(2-1)(25-1) = 1
		structure(2-1)(24-1) = 1
		structure(2-1)(13-1) = 1
		structure(2-1)(23-1) = 1
		structure(3-1)(14-1) = 1
		structure(3-1)(19-1) = 1
		structure(4-1)(36-1) = 1
		structure(5-1)(31-1) = 1
		structure(6-1)(15-1) = 1
		structure(7-1)(27-1) = 1
		structure(8-1)(21-1) = 1
		structure(9-1)(14-1) = 1
		structure(9-1)(17-1) = 1
		structure(9-1)(19-1) = 1
		structure(10-1)(33-1) = 1
		structure(10-1)(34-1) = 1
		structure(11-1)(16-1) = 1
		structure(12-1)(13-1) = 1
		structure(12-1)(18-1) = 1
		structure(13-1)(30-1) = 1
		structure(14-1)(35-1) = 1
		structure(15-1)(21-1) = 1
		structure(16-1)(31-1) = 1
		structure(16-1)(37-1) = 1
		structure(19-1)(20-1) = 1
		structure(19-1)(22-1) = 1
		structure(21-1)(23-1) = 1
		structure(21-1)(24-1) = 1
		structure(23-1)(26-1) = 1
		structure(23-1)(29-1) = 1
		structure(23-1)(25-1) = 1
		structure(26-1)(28-1) = 1
		structure(26-1)(27-1) = 1
		structure(27-1)(30-1) = 1
		structure(28-1)(31-1) = 1
		structure(28-1)(29-1) = 1
		structure(30-1)(31-1) = 1
		structure(31-1)(32-1) = 1
		structure(32-1)(33-1) = 1
		structure(32-1)(35-1) = 1
		structure(32-1)(34-1) = 1
		structure(32-1)(36-1) = 1
		structure(35-1)(37-1) = 1
	}
}
